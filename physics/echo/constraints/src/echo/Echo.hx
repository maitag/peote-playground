...
class Echo {
   ...
   */
  public static function step(world:World, dt:Float, rate:Float = 0, bodyConstraints:BodyConstraints = null) {
    function step_world(world:World, dt:Float) {
      ...
      for (i in 0...world.iterations) {
        ...
        // semmi DIFF: calculate all bodyConstraints
        if (bodyConstraints!=null) bodyConstraints.step(fdt);
