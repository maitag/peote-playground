		...
		switch (window.context.type) {
			case WEBGL, OPENGL, OPENGLES:
				try {
					...
					// add bloom filter to the framebuffer program, be careful it can slow it down
					// todo? fast and dirty blur function to replace the high quality gaussian?
					var blur_kernel_size = 13; 
