...
abstract CombineDisplay(Display) to Display
{
	...
	{	
		this = new Display(x, y, w, h, Color.BLUE);
		...
		// program.setColorFormula( "vec4( vec3(uvAoAlpha*0.2 + light*0.8), uvAoAlpha.a)");
		// test without light
		// program.setColorFormula( "uvAoAlpha");
		// test only light
		program.setColorFormula( "vec4( vec3(light), uvAoAlpha.a )");
