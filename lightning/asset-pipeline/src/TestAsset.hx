...
import asset.generated.Tiles as Asset;
import asset.generated.Tiles.TileID as TileID;
import asset.generated.Tiles.AnimID as AnimID;
...
class TestAsset extends Application
{
	...
	public function start(window:Window)
	{
		...
		program.setMultiTexture(Util.loadTextures(Asset.sheets, "uv_ao_alpha"), "custom");
